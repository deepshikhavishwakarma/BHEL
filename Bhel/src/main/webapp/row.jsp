...
//String Fnarea = (String)session.getAttribute("Fnarea");


/* //String Fnarea=(String)session.getAttribute("Fnarea"); */
//System.out.println("Fnarea878 :"+Fnarea);




//String ID=(String)session.getAttribute("ID"); 
/* //String Fnarea = session.setAttribute("functionalarea", Fnarea); */
 ...
 try {
   ...
   // pstmt.setString(2, password);
    ...
    if (rs.next()) {
        ...
        //Fnarea = rs.getString("functionalarea");
        // System.out.print(".,,.,67688."+Fnarea);
